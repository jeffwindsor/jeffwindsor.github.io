...
echo "<html><head></head><body><ul>" > ${resume_list}
...
for t in "${json[@]}"; do
    ...
    echo "<li><a href="generated/resume-json-${t}.html">${t}</a></li>" >> ${resume_list}
    for f in "${formats[@]}"; do
...
for t in "${fresh[@]}"; do
  ...
  echo "<li><a href="generated/resume-fresh-${t}.html">${t}</a></li>" >> ${resume_list}
  for f in "${formats[@]}"; do
